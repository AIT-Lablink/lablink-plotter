...
public class PlotterSync extends PlotterBase {
  ...
  /** Timestamp of current synchroization step. */
  ...
  public static void main( String[] args ) throws
    ...
    // Instantiate plotter.
    PlotterSync plotter = new PlotterSync( jsonConfig );
   ...
   *   no such element
   */
  public PlotterSync( JSONObject jsonConfig ) throws
      at.ac.ait.lablink.core.client.ex.ClientNotReadyException,
      at.ac.ait.lablink.core.client.ex.CommInterfaceNotSupportedException,
      at.ac.ait.lablink.core.client.ex.DataTypeNotSupportedException,
      at.ac.ait.lablink.core.client.ex.InvalidCastForServiceValueException,
   ...
   * timestamp to the specified time.
   *
   * @param st start time
   */
   ...
   * @param st start time
   */
  public synchronized void setSyncTime( long st ) {
    this.syncTime = st;
  }
  ...
  public synchronized double getElapsedTimeInSeconds() {
    return ( this.syncTime - this.startTime ) * 1e-3;
  }
  ...
  protected void configureClient( JSONObject jsonConfig ) throws
    ...
    PlotterSyncConsumer sync = new PlotterSyncConsumer( this );

    // Specify client configuration (no sync host).
    MqttCommInterfaceUtility.addClientProperties( client, clientDesc,
        scenarioName, groupName, clientName, llPropUri, llSyncUri, sync );
  }
}